...
- **Consultation** — Drone program development, regulatory compliance, system selection

### 💻 Tech Stack

`Python` · `Rust` · `React` · `Tauri` · `ESP-32` · `LoRa` · `Betaflight` · `INAV` · `ArduPilot` · `XGBoost` · `FastAPI`
...
<p align="center">
  <sub>NDAA Compliant · Veteran Owned · Made in the USA</sub>
</p>
